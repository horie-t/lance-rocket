...
set ::program::boards::spec [dict create \
	...
	nexys4_ddr      [dict create  iface spix4   size 128  bitaddr 0x0        memdev {s25fl128sxxxxxx0-spi-x1_x2_x4}] \
	u500_nexys4_ddr [dict create  iface spix4   size 128  bitaddr 0x0        memdev {s25fl128sxxxxxx0-spi-x1_x2_x4}] \
